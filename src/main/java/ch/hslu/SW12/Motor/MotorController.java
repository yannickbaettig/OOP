...
public class MotorController {
    ...
    private void setupControllers(){
        view.getBtnOn().setOnAction(new EventHandler<ActionEvent>() {
            @Override
        ...
        view.getBtnOff().setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(final ActionEvent event) {
                reset();
            }
        ...
        view.getBtnSubtract().setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(final ActionEvent event) {
