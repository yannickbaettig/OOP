package ch.hslu.SW10.Fahrzeug.v3;
...
public class Fahrzeug implements Switchable {
    ...
    //Innere Klasse für Eventhandling
    ...
    public Fahrzeug() {
        ...
        this.motor.addPropertyChangeListener(new MotorPropertyListener());
        // Anonyme innere Klasse für Eventhandling
        this.licht.addPropertyChangeListener(new PropertyChangeListener() {
            @Override
            public void propertyChange(PropertyChangeEvent evt) {
